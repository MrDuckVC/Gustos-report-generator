...
class StillWhiteSingleVarietyWinesTopWinesInTheWorldByMedalCount(TopWinesReport):
    ...
    @property
    def title(self) -> str:
        return "4.3.1 Still White Single variety wines: Top wines in the world by Medal Count"
