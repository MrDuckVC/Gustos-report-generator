...
class StillRedRoseWhiteBlendsTopWineriesInTheWorldByAwardedWines(Report):
    @property
    def title(self):
        return "4.3 Still  Red / Rose / White Blends: Top Wineries in the World by Awarded wines"
