...
class StillRoseSingleVarietyWinesTopWinesInTheWorldByMedalCount(TopWinesReport):
    ...
    @property
    def title(self) -> str:
        return "4.3.1 Still Rose Single variety wines: Top wines in the world by Medal Count"
