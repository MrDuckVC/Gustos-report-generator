...
class ByGrapeVarietiesMostAwardedGrapesInRedStillSingleVarietyWines(ContinentsTabReport):
    @property
    def title(self):
        return "4.3.2 By Grape varieties: Most awarded grapes in Red Still Single Variety wines"
