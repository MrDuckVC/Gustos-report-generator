...
class ByGrapeVarietiesMostAwardedGrapesInWhiteStillSingleVarietyWines(ContinentsTabReport):
    @property
    def title(self):
        return "4.3.2 By Grape varieties: Most awarded grapes in White Still Single Variety wines"
