...
class ByWhiteStillBlendsNumberWineryReport(ByNumberWineryReport):
    @property
    def title(self):
        return "8.1 Your Winery Position by number of awarded White Still Blends"

    @property
    def parameter_title(self):
        return "Awarded White Still Blends"
