...
class ByRedStillBlendWineGWMRWineryReport(ByWineWineryReport):
    @property
    def title(self):
        return "8.2 Your Best Red Still Blend Wine Position by GWMR score"

    @property
    def parameter_title(self):
        return "Best Red Still Blend GWMR Score"
