...
class SparklingPearlWinesGlobalParticipantsMedalsAndAwardedWines(ContinentsTabReport):
    @property
    def title(self):
        return "4.1.2 Sparkling & Pearl Wines: Global participants, Medals and Awarded wines"
