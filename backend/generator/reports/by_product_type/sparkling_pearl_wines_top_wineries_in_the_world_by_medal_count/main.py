...
class SparklingPearlWinesTopWineriesInTheWorldByMedalCount(TopWineriesReport):
    ...
    @property
    def title(self) -> str:
        return "4.1.1 Sparkling & Pearl Wines: Top Wineries in the World by Medal Count"
