...
class CountryRegionComparisonByTotalNumberOfMedalsForWinery(WineryReport):
    @property
    def title(self):
        return "8.3 Country/Region comparison by Total number of medals for winery"
    ...
    def render(self, throw_exception=False):
        """Country/Region comparison by Total number of medals for winery"""
        type_report = "get_comparison_by_total_number_of_medal_for_winery"
        ...
        with self.database.connect() as connection:
            ...
            param_name = "Total number of medals"
            ...
            try:
                ...
                if total_number_of_medal >= region_average_number_of_medal:
                    region_higher_lower_than_the_average = self.higher_than_the_average(total_number_of_medal, region_average_number_of_medal)
                    cat_region = "Higher than the average in your wine region"
                else:
                    region_higher_lower_than_the_average = self.lower_than_the_average(total_number_of_medal, region_average_number_of_medal)
                    cat_region = "Lower than the average in your region"

                name_svg_region = self.build_bars_base64(
                    a=total_number_of_medal,
        ...
        if total_number_of_medal >= country_average_number_of_medal:
            country_higher_lower_than_the_average = self.higher_than_the_average(total_number_of_medal,
                                                                                 country_average_number_of_medal)
            cat_country = "Higher than the average in your country"
        else:
            country_higher_lower_than_the_average = self.lower_than_the_average(total_number_of_medal,
                                                                                country_average_number_of_medal)
        ...
        return self.render_template(
            ...
            average_value=total_number_of_medal,
            region_name=region_name,
            total_description="Total number of medals",
        )
