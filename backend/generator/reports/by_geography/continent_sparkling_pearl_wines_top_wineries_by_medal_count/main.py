...
class ContinentSparklingPearlWinesTopWineriesByCountReport(ContinentReport, TopWineriesReport):
    @property
    ...
    @property
    def title(self) -> str:
        return "4.5.1 <Continent>: Sparkling & Pearl Wines: Top Wineries by Medal Count"
