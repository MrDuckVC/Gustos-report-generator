...
class ContinentStillWhiteBlendsTopWineriesByMedalCountReport(ContinentReport, TopWineriesReport):
    @property
    ...
    @property
    def title(self) -> str:
        return "4.5.1 <Continent>: Still White Blends: Top Wineries by Medal Count"
