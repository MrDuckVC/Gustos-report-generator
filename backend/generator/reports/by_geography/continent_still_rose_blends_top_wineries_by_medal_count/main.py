...
class ContinentStillRoseBlendsTopWineriesByMedalCountReport(ContinentReport, TopWineriesReport):
    @property
    ...
    @property
    def title(self) -> str:
        return "4.5.1 <Continent>: Still Rose Blends: Top Wineries by Medal Count"
