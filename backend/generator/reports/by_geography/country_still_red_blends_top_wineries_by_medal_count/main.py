...
class CountryStillRedBlendsTopWineriesByMedalCountReport(TopWineriesReport, CountryReport):
    @property
    ...
    @property
    def title(self) -> str:
        return "4.5.1 <Country>: Still Red Blends Top Wineries by Medal Count"
