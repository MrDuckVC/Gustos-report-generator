...
class ContinentStillRoseSingleVarietyTopWineriesByMedalCountReport(ContinentReport, TopWineriesReport):
    @property
    ...
    @property
    def title(self) -> str:
        return "4.5.1 <Continent>: Still Rose Single Variety: Top Wineries by Medal Count"
