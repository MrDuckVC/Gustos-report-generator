...
class ContinentTopStillRedSingleVarietyByMedalCountReport(TopWinesReport, ContinentReport):
    ...
    @property
    def title(self) -> str:
        return "4.5.1 <Continent>: Top Still Red Single Variety by Medal Count"
