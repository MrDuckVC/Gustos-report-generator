...
class ContinentStillRedRoseWhiteBlendsTopWineriesByAwardedWinesReport(ContinentReport):
    @property
    def title(self):
        return "4.5 <Continent>: Still Red / Rose / White Blends: Top Wineries by Awarded wines"
