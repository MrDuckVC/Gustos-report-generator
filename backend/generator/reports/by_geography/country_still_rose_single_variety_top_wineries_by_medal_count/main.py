...
class CountryStillRoseSingleVarietyTopWineriesByMedalCountReport(TopWineriesReport, CountryReport):
    @property
    ...
    @property
    def title(self) -> str:
        return "4.5.1 <Country>: Still Rose Single Variety: Top Wineries by Medal Count"
