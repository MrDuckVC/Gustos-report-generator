...
class ContinentTopStillRoseSingleVarietyByMedalCountReport(TopWinesReport, ContinentReport):
    ...
    @property
    def title(self) -> str:
        return "4.5.3 <Continent>: Top Still Rose Single Variety by Medal Count"
