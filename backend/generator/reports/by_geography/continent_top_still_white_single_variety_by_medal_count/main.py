...
class ContinentTopStillWhiteSingleVarietyByMedalCountReport(TopWinesReport, ContinentReport):
    ...
    @property
    def title(self) -> str:
        return "4.5.2 <Continent>: Top Still White Single Variety by Medal Count"
