...
class CountryStillWhiteSingleVarietyTopWineriesByMedalCountReport(TopWineriesReport, CountryReport):
    @property
    ...
    @property
    def title(self) -> str:
        return "4.5.1 <Country>: Still White Single Variety: Top Wineries by Medal Count"
