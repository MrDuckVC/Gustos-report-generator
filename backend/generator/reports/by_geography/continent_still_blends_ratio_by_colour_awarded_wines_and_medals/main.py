...
class ContinentStillBlendsRatioByColourAwardedWinesAndMedalsReport(ContinentReport):
    @property
    def title(self):
        return "4.5 <Continent>: Still Blends ratio by Colour: Awarded wines and Medals"
