...
class ContinentRedRoseWhiteWinesRatioAwardedWinesAndMedalsReport(ContinentReport):
    @property
    def title(self):
        return "4.5 <Continent>: Red / Rose / White wines ratio: Awarded wines and Medals"
