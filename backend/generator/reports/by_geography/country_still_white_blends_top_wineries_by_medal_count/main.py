...
class CountryStillWhiteBlendsTopWineriesByMedalCountReport(TopWineriesReport, CountryReport):
    @property
    ...
    @property
    def title(self) -> str:
        return "4.5.2 <Country>: Still White Blends Top Wineries by Medal Count"
