...
class CountryTopStillWhiteSingleVarietyByMedalCountReport(TopWinesReport, CountryReport):
    ...
    @property
    def title(self) -> str:
        return "4.5.2 <Country>: Top Still White Single Variety by Medal Count"
